          ...
          <header className="flex justify-between items-center py-8">
            ...
            <nav className="hidden md:block">
              <ul className="flex space-x-8">
                <li><a href="#features" className="font-medium hover:text-purple-500 transition-colors">Features</a></li>
                <li><a href="#how-it-works" className="font-medium hover:text-purple-500 transition-colors">How It Works</a></li>
                <li><a href="#pricing" className="font-medium hover:text-purple-500 transition-colors">Pricing</a></li>
                <li><a href="#contact" className="font-medium hover:text-purple-500 transition-colors">Contact</a></li>
              </ul>
            </nav>
          </header>
